...
19. [父类实现深拷贝时，子类如何实现深度拷贝](#19)
20. [KVO，NSNotification，delegate及block区别](#20)
21. [为什么Block用copy关键字？](#20)
...
19. <span id="19">父类实现深拷贝时，子类如何实现深度拷贝</span>
...
20. <span id="20">KVO，NSNotification，delegate及block区别</span>
...
20. <span id="20">为什么Block用copy关键字？</span>
...
>注：如果在一个方法中异步调用block，等执行异步回调时，stack block可以已经释放。
